...
abstract class $ResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({Object? data, Exception? exception});
...
class _$ResponseImpl implements _Response {
  const _$ResponseImpl({this.data, this.exception});
  ...
  @override
  String toString() {
    return 'Response(data: $data, exception: $exception)';
  }
...
abstract class _Response implements Response {
  const factory _Response({final Object? data, final Exception? exception}) =
      _$ResponseImpl;
